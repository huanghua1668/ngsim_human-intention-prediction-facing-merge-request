...
def loadData():
    ...
    # load data
    dirs="data_begin_with_lateral_move_10_data_point_per_sample/"
    ...
    if testSizeEffect:
        ...
        x_train=x_train[:sz]
        y_train=y_train[:sz]
    print('x_train', x_train.shape[0]/seqLen, np.mean(y_train==1),'coop rate')
    ...
    print('x_validate', x_validate.shape[0]/seqLen, np.mean(y_validate==1),'coop rate')
    ...
    #    y_test=y_test[:sz]
    #
    #print('x_test', x_test.shape[0]/seqLen, np.mean(y_test==1),'coop rate')
