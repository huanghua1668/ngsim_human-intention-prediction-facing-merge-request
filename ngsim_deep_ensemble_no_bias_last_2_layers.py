...
if __name__ == "__main__":
    ...
    if not trained:
            ...
            for j in range(ensembles):
                ...
                for epoch in range(epochs):
                    ...
                    if accuracy > bestValidationAcc:
                        ...
                        PATH = '/home/hh/data/deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth'.format(i,j)
                        torch.save(stateDict, PATH)
                        bestValidationAcc = accuracy
                dir = '/home/hh/data/loss_deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth.npz'.format(i, j)
                np.savez(dir, a=np.array(losses), b=np.array(losses_validate))
                dir = '/home/hh/data/acc_deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth.npz'.format(i, j)
                ...
                plt.legend()
                dir = '/home/hh/data/loss_deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth.png'.format(i, j)
                plt.savefig(dir)
                ...
                plt.legend()
                dir = '/home/hh/data/acc_deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth.png'.format(i, j)
                plt.savefig(dir)
        ...
        for i in range(runs):
            ...
            for j in range(ensembles):
                model = Model_bilinear(inputs, hiddenUnits, dropoutRate)
                PATH = '/home/hh/data/deep_ensemble_run{}_ensemble{}_no_bias_last_2_layers.pth.pth'.format(i, j)
            ...
            dir = '/home/hh/data/roc_deep_ensemble_run{}_no_bias_last_2_layers.pth.png'.format(i)
            plt.savefig(dir)
